...
module.exports.attendaceGetAll = function(req, res){
    ...
    StudentProfile.findById(studentId).select("attendance")
...
module.exports.attendanceAddOne = function(req, res){
    ...
    StudentProfile.findById(studentId).exec(function(err, student){
        let response = {
            status : 201,
            message: student
        }
        if(err){
            ...
            if(req.body && req.body.course && req.body.session){
                console.log(student);
